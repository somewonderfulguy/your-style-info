...
const HeaderHeightDispatchContext = createContext<Dispatch<SetStateAction<number>> | undefined>(undefined)
HeaderHeightDispatchContext.displayName = 'HeaderHeightDispatchContext'

const HeaderHeightProvider = ({children}: {children: ReactNode | ReactNode[]}) => {
...
const useHeaderHeightState = () => {
  ...
  if(context === undefined) {
    throw new Error('useHeaderHeightState must be used within a HeaderHeightProvider')
  }
  return context
}
...
const useHeaderHeightDispatch = () => {
  ...
  if(context === undefined) {
    throw new Error('useHeaderHeightDispatch must be used within a HeaderHeightProvider')
  }
  return context
}
